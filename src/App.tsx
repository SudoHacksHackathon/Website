...
const App = () => {
  ...
  // TODO: fix interactivity (it doesn't work??)
  return (
    <>
      <Particles
        id="tsparticles"
      ...
      <div className="bg-[#111111] h-full w-full flex justify-center place-items-center selection:bg-slate-200 selection:text-black p-3">
        <Draggable handle=".handle" bounds="parent">
          <div className="rounded-xl w-[min(100%,_75rem)] h-[min(100%,_42.1875rem)] bg-black font-mono flex flex-col">
            <div className="handle cursor-move rounded-t-xl w-full h-7 bg-white border-x-2 border-t-2 border-slate-700 select-none">
