    ...
    <div className="bg-slate-900 h-full w-full flex justify-center place-items-center">
      <div className="rounded-xl w-3/4 h-[80vh] bg-black font-mono">
        ...
        <div className="p-5">
          ...
          {revealed && (
            <>
              <h1 className="text-slate-50 text-5xl mb-5">
              ...
              <p className="text-slate-50 text-l">
                ...
                all over the world. In four days, participants are tasked with
                building and presenting an application concerning social good.
                There are a <span className="text-gray-600">**</span>
